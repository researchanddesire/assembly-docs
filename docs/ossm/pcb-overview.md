...
| --- | --- | --- |
| PCB source folder | [`hardware/pcb/`](https://github.com/researchanddesire/ossm/tree/main/hardware/pcb) | Local OSSM PCB source boundary. |
| PCB migration notes | [`hardware/pcb/README.md`](https://github.com/researchanddesire/ossm/blob/main/hardware/pcb/README.md) | Current status and upstream reference. |
