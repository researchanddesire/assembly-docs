...
| Area | Source |
| --- | --- |
| Product-level BOM | [`hardware/bom.csv`](../hardware/bom.csv) |
| CAD release exports | [`hardware/cad/`](../hardware/cad/) |
| PCB source notes | [`hardware/pcb/`](../hardware/pcb/) |
| Cable harness sources | [`hardware/cables/`](../hardware/cables/) |
