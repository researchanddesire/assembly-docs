...
description: "Historical reference for the retired MkDocs assembly pipeline."
---

{/* Ported from MkDocs: how-this-site-works.md */}

<Warning title="Historical pipeline">
  This page preserves the previous MkDocs assembly pipeline for migration
  reference. Fumadocs in rad-app and the reviewed bidirectional content sync now
  own publication.
</Warning>
