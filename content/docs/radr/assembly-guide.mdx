...
_Insert the screen into the bottom lip first._
![Display seated flush in the RADR front housing](assets/screen-seated-flush.webp)

_Screen seated flush in the housing._
